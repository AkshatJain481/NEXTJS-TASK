...
const AudioPlayerCard = ({ audioSrc, imageSrc }) => {
  ...
  return (
    <div className="bg-[#CCC1DA] sm:mr-24 rounded-lg p-2 min-[550px]:p-4 min-[550px]:h-[100px] h-[80px] flex items-center min-[550px]:space-x-5 space-x-2 w-full">
      ...
      <div className="relative ">
        <div className=" min-[550px]:w-[60px] min-[550px]:h-[60px] h-[40px] w-[40px] rounded-full overflow-hidden">
          <Image src={imageSrc} alt="Album cover" className=' max-[550px]:w-[40px] max-[550px]:h-[40px] ' width={60} height={60} />
        </div>
        <svg
          width="20"
          height="26"
          ...
          className="absolute bottom-1 -left-2  max-[550px]:h-[16px]"
        >
          <path
