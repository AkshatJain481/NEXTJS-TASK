  ...
  return (
    <section className='m-[10%]'>
        <div className='grid grid-cols-2 gap-6'>
            ...
            <div className='border border-[#CED4DA] rounded-lg p-10 '>
                <h3 className='flex items-center font-bold text-[24px]'>
                    <span>
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className='mr-6'>
                        ...
                        <button className='text-[#8064A2] border-[#8064A2] border font-bold rounded-lg px-8 py-2'>Connect</button>
            </div>

            <div className='border border-[#CED4DA] rounded-lg p-10 relative'>
                <h3 className='flex items-center font-bold text-[24px]'>
                    <span>
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className='mr-6'>
                    ...
                    <rect width="40" height="40" fill="white"/>
                        ...
                        <p className='text-[18px]  my-8 '>
                        Find a class, school, playground, auditorium, studio, shop or an event venue.  Book a slot at venues that allow booking through hobbycue.                        </p>

                        <button className='text-[#8064A2] border-[#8064A2] border font-bold rounded-lg px-8 py-2 absolute bottom-10'>Meet up</button>
            </div>
            ...
            <div className='border border-[#CED4DA] rounded-lg p-10'>
                <h3 className='flex items-center font-bold text-[24px]'>
                    <span>
                        ...
                        <button className='text-[#8064A2] border-[#8064A2] border font-bold rounded-lg px-8 py-2'>Get it</button>
            </div>
            ...
            <div className='border border-[#CED4DA] rounded-lg p-10 relative'>
                <h3 className='flex items-center font-bold text-[24px]'>
                    ...
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className='mr-6'>
                        ...
                        <button className='text-[#8064A2] border-[#8064A2] border font-bold rounded-lg px-8 py-2 absolute bottom-10'>Attend</button>
            </div>
